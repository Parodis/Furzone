...
(function (r, t, l) {
    ...
    f.prototype._formByNameOrNode = function (a) {
        return "object" === (typeof a === "undefined" ? "undefined" : _typeof(a)) ? a : t.forms[a];
    };
    ...
    f.prototype._hooks = {
        ...
        "default": function _default(a, c) {
            return a.value !== c;
        },
        matches: function matches(a, c) {
            var b = this.form[c];
            return b ? a.value === b.value : !1;
        },
        valid_email: function valid_email(a) {
            return q.test(a.value);
        },
        valid_emails: function valid_emails(a) {
            a = a.value.split(/\s*,\s*/g);
            for (var c = 0, b = a.length; c < b; c++) {
                if (!q.test(a[c])) return !1;
            }return !0;
        },
        min_length: function min_length(a, c) {
            return g.test(c) ? a.value.length >= parseInt(c, 10) : !1;
        },
        max_length: function max_length(a, c) {
            return g.test(c) ? a.value.length <= parseInt(c, 10) : !1;
        },
        exact_length: function exact_length(a, c) {
            return g.test(c) ? a.value.length === parseInt(c, 10) : !1;
        },
        greater_than: function greater_than(a, c) {
            return m.test(a.value) ? parseFloat(a.value) > parseFloat(c) : !1;
        },
        less_than: function less_than(a, c) {
            return m.test(a.value) ? parseFloat(a.value) < parseFloat(c) : !1;
        },
        alpha: function alpha(a) {
            return y.test(a.value);
        },
        alpha_numeric: function alpha_numeric(a) {
            return z.test(a.value);
        },
        alpha_dash: function alpha_dash(a) {
        ...
        decimal: function decimal(a) {
            return m.test(a.value);
        },
        is_natural: function is_natural(a) {
            return B.test(a.value);
        },
        is_natural_no_zero: function is_natural_no_zero(a) {
            return C.test(a.value);
        },
        valid_ip: function valid_ip(a) {
            return D.test(a.value);
        },
        valid_base64: function valid_base64(a) {
            return E.test(a.value);
        },
        valid_url: function valid_url(a) {
            return G.test(a.value);
        },
        valid_credit_card: function valid_credit_card(a) {
            ...
            for (var f = a.length - 1; 0 <= f; f--) {
                b = a.charAt(f), b = parseInt(b, 10), d && 9 < (b *= 2) && (b -= 9), c += b, d = !d;
            }return 0 === c % 10;
        },
        is_file_type: function is_file_type(a, c) {
        ...
        greater_than_date: function greater_than_date(a, c) {
            var b = this._getValidDate(a.value),
                d = this._getValidDate(c);
            return d && b ? b > d : !1;
        },
        less_than_date: function less_than_date(a, c) {
            var b = this._getValidDate(a.value),
                d = this._getValidDate(c);
            return d && b ? b < d : !1;
        },
        greater_than_or_equal_date: function greater_than_or_equal_date(a, c) {
            var b = this._getValidDate(a.value),
                d = this._getValidDate(c);
            return d && b ? b >= d : !1;
        },
        less_than_or_equal_date: function less_than_or_equal_date(a, c) {
            var b = this._getValidDate(a.value),
                d = this._getValidDate(c);
            return d && b ? b <= d : !1;
        }
